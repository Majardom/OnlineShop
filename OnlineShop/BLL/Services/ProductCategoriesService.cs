...
namespace BLL.Services
{
    ...
    public class ProductCategoriesService : BaseService, IProductCategoriesService
    {
        ...
        public CategoryDescriptionDto GetCategoryDescriptionDtoByProductCategoryId(int id)
        {
            ...
            return Mapper.Map<CategoryDescription, CategoryDescriptionDto>(resultFromDb);
        }
    }
}
